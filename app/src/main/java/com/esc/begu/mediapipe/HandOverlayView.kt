        ...
        results?.let { handLandmarkerResult ->
            ...
            for (landmark in handLandmarkerResult.landmarks()) {
                ...
                HandLandmarker.HAND_CONNECTIONS.forEach {
                    canvas.drawLine(
                        landmark[it!!.start()].x() * scaledImageWidth + offsetX,
                        landmark[it.start()].y() * scaledImageHeight + offsetY,
                        landmark[it.end()].x() * scaledImageWidth + offsetX,
                        landmark[it.end()].y() * scaledImageHeight + offsetY,
                        linePaint
                    )
                }
            }
